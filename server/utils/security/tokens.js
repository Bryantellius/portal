    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                token = jsonwebtoken_1["default"].sign(payload, config_1["default"].secret_key);
                return [4 /*yield*/, models_1["default"].AccessToken.create({
...
var ValidToken = function (token) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, validatedToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                payload = jsonwebtoken_1["default"].decode(token);
                return [4 /*yield*/, models_1["default"].AccessToken.findOne({
                        where: {
